...
class TestNlvrLanguage(SemparseTestCase):
    ...
    def test_logical_form_with_box_filter_executes_correctly(self):
        ...
        logical_form = "(box_exists (box_filter all_boxes (object_color_none_equals color_blue)))"
    ...
    def test_logical_form_with_box_filter_within_object_filter_executes_correctly(self):
        ...
        #  Original logical_form below I think is wrong; this would select box with at least 1 blue item,
        #  and then check if the total number of objects in those boxes is greater than 3
        logical_form = "(object_count_greater_equals 3 \
                            (object_in_box \
                                (box_filter all_boxes (object_color_any_equals color_blue))))"
    ...
    def test_spatial_relations_return_objects_in_the_same_box(self):
        ...
        logical_form = (
            ...
            " (box_filter all_boxes (object_shape_any_equals shape_circle)))))"
        )
        ...
        logical_form = (
            ...
            " (box_filter all_boxes (object_shape_all_equals shape_square)))))"
        )
        assert self.custom_language.execute(logical_form) is True
    ...
    def test_spatial_relations_with_objects_from_different_boxes(self):
        ...
        assert (
            self.custom_language.execute(
                ...
                " (box_filter all_boxes (object_shape_any_equals shape_triangle)))))"
            )
            is True
        )
    ...
    def test_same_and_different_execute_correctly(self):
        ...
        assert (
            self.custom_language.execute(
                ...
                " (box_filter all_boxes"
                " (box_filter_and object_shape_same (object_count_equals 2)))))"
            )
            is True
        )
        ...
        assert (
            self.custom_language.execute(
                ...
                "(box_filter all_boxes object_shape_different)))"
            )
            is True
        )
    ...
    def test_get_action_sequence_handles_multi_arg_functions(self):
        ...
        # box_color_filter
        logical_form = "(box_exists (box_filter all_boxes (object_color_all_equals color_blue)))"
        ...
        assert "<Set[Box],<Set[Object]:bool>:Set[Box]> -> box_filter" in action_sequence
        ...
        # box_shape_filter
        logical_form = "(box_exists (box_filter all_boxes (object_shape_none_equals shape_square)))"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        ...
        # box_count_filter
        logical_form = "(box_exists (box_filter all_boxes (object_count_equals 3)))"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        ...
        logical_form = "(box_exists (box_filter all_boxes (* object_shape_different yellow)))"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        assert (
            "<Set[Object]:bool> -> [*, <Set[Object]:bool>, <Set[Object]:Set[Object]>]"
            in action_sequence
        )
        ...
        # assert_color
        logical_form = "(object_color_all_equals color_blue all_objects)"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        assert "bool -> [<Color,Set[Object]:bool>, Color, Set[Object]]" in action_sequence

        # assert_shape
        logical_form = "(object_shape_all_equals shape_square all_objects)"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        assert "bool -> [<Shape,Set[Object]:bool>, Shape, Set[Object]]" in action_sequence

        # assert_box_count
        logical_form = "(box_count_equals 1 all_boxes)"
        action_sequence = language.logical_form_to_action_sequence(logical_form)
    ...
    def test_logical_form_with_object_filter_returns_correct_action_sequence(self):
        ...
        assert action_sequence == [
            ...
            "<Color,Set[Object]:bool> -> object_color_all_equals",
            "Color -> color_black",
            "Set[Object] -> [<Set[Object]:Set[Object]>, Set[Object]]",
            "<Set[Object]:Set[Object]> -> [*, <Set[Object]:Set[Object]>, <Set[Object]:Set[Object]>]",
    ...
    def test_logical_form_with_box_filter_returns_correct_action_sequence(self):
        ...
        assert action_sequence == [
            ...
            "Set[Box] -> [<Set[Box],<Set[Object]:bool>:Set[Box]>, Set[Box], <Set[Object]:bool>]",
            "<Set[Box],<Set[Object]:bool>:Set[Box]> -> box_filter",
            "Set[Box] -> all_boxes",
    ...
    def test_logical_form_with_box_filter_and_returns_correct_action_sequence(self):
        language = self.languages[0]
        logical_form = (
            "(box_count_greater 3 (box_filter all_boxes"
            " (box_filter_and (object_count_not_equals 4)"
            " (object_shape_any_equals shape_circle))))"
        )
        action_sequence = language.logical_form_to_action_sequence(logical_form)
        assert action_sequence == [
            "@start@ -> bool",
            ...
            "<Set[Box],<Set[Object]:bool>:Set[Box]> -> box_filter",
            "Set[Box] -> all_boxes",
            "<Set[Object]:bool> -> [<<Set[Object]:bool>,<Set[Object]:bool>:<Set[Object]:bool>>, <Set[Object]:bool>, <Set[Object]:bool>]",
            "<<Set[Object]:bool>,<Set[Object]:bool>:<Set[Object]:bool>> -> box_filter_and",
